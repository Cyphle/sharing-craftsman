...
public class KnowledgeAddedEventHandlerTest {
  ...
  private KnowledgeAddedEventHandlerForTest knowledgeAddedEventHandler;

  @Before
  public void setUp() {
    knowledgeAddedEventHandler = new KnowledgeAddedEventHandlerForTest(elasticSearchService);
  }
